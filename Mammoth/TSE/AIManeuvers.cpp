...
constexpr Metric MAX_DOCK_DISTANCE =		(15.0 * LIGHT_SECOND);
constexpr Metric MAX_ESCORT_DISTANCE =		(12.0 * LIGHT_SECOND);
constexpr Metric MAX_GATE_DISTANCE =		(90.0 * KLICKS_PER_PIXEL);
constexpr Metric MAX_IN_FORMATION_DELTA	=	(2.0 * KLICKS_PER_PIXEL);
constexpr Metric MAX_TARGET_OF_OPPORTUNITY_RANGE = (20.0 * LIGHT_SECOND);
constexpr int MAX_TARGETS =					10;
constexpr Metric MIN_FLYBY_SPEED =			(0.2 * LIGHT_SPEED);
...
constexpr Metric MIN_TARGET_DIST =			(3.0 * LIGHT_SECOND);
...
constexpr Metric MIN_FLYBY_SPEED2 =			(MIN_FLYBY_SPEED * MIN_FLYBY_SPEED);
...
constexpr Metric MAX_FLOCK_DIST =			(600.0 * KLICKS_PER_PIXEL);
constexpr Metric MAX_FLOCK_DIST2 =			(MAX_FLOCK_DIST * MAX_FLOCK_DIST);
constexpr Metric FLOCK_SEPARATION_RANGE =	(100.0 * KLICKS_PER_PIXEL);
constexpr Metric FLOCK_SEPARATION_RANGE2 =	(FLOCK_SEPARATION_RANGE * FLOCK_SEPARATION_RANGE);
...
constexpr Metric MAX_IMMOBILE_SPEED =		(1.0 * KLICKS_PER_PIXEL);
constexpr Metric MAX_IMMOBILE_SPEED2 =		MAX_IMMOBILE_SPEED * MAX_IMMOBILE_SPEED;
...
void CAIBehaviorCtx::ImplementFireAllWeaponsOnTarget (CShip* pShip,
	...
	if (iWeapon == -1)
		...
		{
		auto iWeaponToFire = pShip->SelectWeapon(iWeapon, iWeaponVariant);
